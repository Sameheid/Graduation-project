...
const char *ssid = "WEE060BF";
const char *password = "Sameh@1223";
/* ======================================== */
...
<title>"Smart and Clean Fire-Fighting Vehicle"</title>
...
<body>
  <h3>Smart and Clean Fire-Fighting Vehicle</h3>
</body>
</html>
<img src="" id="vdstream">
...
<br><br>
<button class="button" ontouchstart="button_ontouchstart_handle('ZT')" ontouchend="button_ontouchend_handle()" onmousedown="button_onmousedown_handle('ZM')" onmouseup="button_onmouseup_handle()"><b>STOP</b></button>
<br><br>
<button class="button" ontouchstart="button_ontouchstart_handle('XT')" ontouchend="button_ontouchend_handle()" onmousedown="button_onmousedown_handle('XM')" onmouseup="button_onmouseup_handle()"><b>TURN_ON</b></button>
<br><br>
<button class="button" ontouchstart="button_ontouchstart_handle('YT')" ontouchend="button_ontouchend_handle()" onmousedown="button_onmousedown_handle('YM')" onmouseup="button_onmouseup_handle()"><b>TURN_OFF</b></button>
<br><br>
<button class="button" ontouchstart="button_ontouchstart_handle('ET')" ontouchend="button_ontouchend_handle()" onmousedown="button_onmousedown_handle('EM')" onmouseup="button_onmouseup_handle()"><b>LED</b></button>
...
<table style="width:0px;margin:auto;table-layout:fixed" CELLSPACING=10>
<tr>
...
<td style="text-align:right;font-weight:normal;width:20px;" id="slider_pwm_Speed_id"></td>
</tr>
...
<td style="text-align:right;" id="slider_pwm_LED_id"></td>
</tr>
...
<td style="text-align:right;" id="slider_Pan_id"></td>
</tr>
...
<td style="text-align:right;" id="slider_Tilt_id"></td>
</tr>
</table>
...
void Move_Forward() {
  ...
  String dataToSend = "MF";  // Data to be sent
...
void Move_Backward() {
  ...
  String dataToSend = "MB";  // Data to be sent
  Serial2.println(dataToSend);
  Serial.println("Sent: " + dataToSend);
  delay(10);
}
...
void Move_Right() {
  ...
  String dataToSend = "MR";  // Data to be sent
  Serial2.println(dataToSend);
  Serial.println("Sent: " + dataToSend);
  delay(10);
}
...
void Move_Left() {
  ...
  String dataToSend = "ML";  // Data to be sent
  Serial2.println(dataToSend);
  Serial.println("Sent: " + dataToSend);
  delay(10);
}
...
void Move_Stop() {
  ...
  String dataToSend = "MS";  // Data to be sent
  Serial2.println(dataToSend);
  Serial.println("Sent: " + dataToSend);
  delay(10);
}
void TURN_ON() {
  ...
  String dataToSend = "TN";  // Data to be sent
  Serial2.println(dataToSend);
  Serial.println("Sent: " + dataToSend);
  delay(10);
}
void TURN_OFF() {
  ...
  String dataToSend = "TF";  // Data to be sent
  Serial2.println(dataToSend);
  Serial.println("Sent: " + dataToSend);
  delay(10);
}
...
void LED_ON() {
  if (digitalRead(LED_OnBoard1) == LOW) {
    digitalWrite(LED_OnBoard1, HIGH);
    Serial.println("LED turned ON.");
    delay(10);
  } else {
    digitalWrite(LED_OnBoard1, LOW);
